    ...
    constructor() {
        ...
        this.renderBackImage = () => {
            ...
            if (backImage) {
                ...
                ]} source={require('../../../assets/images/back-icon.png')} fadeDuration={0}/>
                );
            }
        };
        this.handlePress = () => this.props.onPress && requestAnimationFrame(this.props.onPress) && console.log('btn press');
    }
    renderLabel() {
        const { label, truncatedLabel, allowFontScaling, labelVisible, backImage, labelStyle, tintColor, screenLayout, } = this.props;
        ...
        leftLabelText === label ? this.handleLabelLayout : undefined} style={[
            styles.label,
        ...
        return (<MaskedView maskElement={<View style={styles.iconMaskContainer}>
            <Image source={require('../../../assets/images/back-icon-mask.png')} style={styles.iconMask}/>
...
const styles = StyleSheet.create({
    container: Object.assign({ alignItems: 'center', flexDirection: 'row' }, Platform.select({
        ios: null,
        default: {
            marginVertical: 3,
            marginHorizontal: 11,
